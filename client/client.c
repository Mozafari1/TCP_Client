// Simple code for a client server written in C language
...
int main (int argc, char *argv[]){
        ...
        char buffer[512];
        char *ID = "xxxxxx"; // Type in student number
        ...
        if(server==NULL){
                printf(stderr, "Du har ikke angit hostname eller portnummer\n");
                exit(0);
        }
        ...
        bzero(buffer, 512);
        buffer[0] = 0x01;
        unsigned M_lengde= htons((short)0x02);
